  ...
  const TRANSLATIONS = {
    en: {
      ...
      auth: {
        ...
        emailRequiredDialogTitle: 'Add your email',
        emailRequiredDialogDescription: 'Administrator accounts now need an email on file for password-reset and forgot-username recovery. Add yours to continue.',
        emailRequiredSavedToast: 'Email saved.',
      ...
      bookInfo: {
        openBtnTitle: 'Book Search',
        openBtnLabel: 'Book Search',
        heading: 'Book Search',
        isbnLabel: 'ISBN',
        isbnPlaceholder: 'ISBN or barcode',
        titleLabel: 'Title',
        titlePlaceholder: 'Book title',
        authorLabel: 'Author',
        ...
        searchBtn: 'Search',
        backBtn: 'Back',
        addToWheelBtn: 'Add to Wheel',
        pickHint: 'Multiple books matched. Pick one to see details.',
        linksHeading: 'Find this book online',
        googleBooksLink: 'Google Books',
        openLibraryLink: 'Open Library',
        goodreadsLink: 'Goodreads',
        bnLink: 'Barnes & Noble',
        amazonLink: 'Amazon',
        needsInputError: 'Enter an ISBN or title to search.',
        noResultsError: 'No results found for that search.',
        isbnPrefix: 'ISBN: '
      },
      stats: {
        openBtnLabel: 'Stats',
    ...
    es: {
      ...
      auth: {
        ...
        emailRequiredDialogTitle: 'Añade tu correo electrónico',
        emailRequiredDialogDescription: 'Las cuentas de administrador ahora necesitan un correo electrónico registrado para la recuperación de contraseña y de nombre de usuario. Añade el tuyo para continuar.',
        emailRequiredSavedToast: 'Correo electrónico guardado.',
      ...
      bookInfo: {
        openBtnTitle: 'Búsqueda de libros',
        openBtnLabel: 'Búsqueda de libros',
        heading: 'Búsqueda de libros',
        isbnLabel: 'ISBN',
        isbnPlaceholder: 'ISBN o código de barras',
        titleLabel: 'Título',
        titlePlaceholder: 'Título del libro',
        authorLabel: 'Autor',
        ...
        searchBtn: 'Buscar',
        backBtn: 'Atrás',
        addToWheelBtn: 'Añadir a la rueda',
        pickHint: 'Varios libros coinciden. Elige uno para ver los detalles.',
        linksHeading: 'Encuentra este libro en línea',
        googleBooksLink: 'Google Books',
        openLibraryLink: 'Open Library',
        goodreadsLink: 'Goodreads',
        bnLink: 'Barnes & Noble',
        amazonLink: 'Amazon',
        needsInputError: 'Introduce un ISBN o título para buscar.',
        noResultsError: 'No se encontraron resultados.',
        isbnPrefix: 'ISBN: '
      },
      stats: {
    ...
    pl: {
      ...
      auth: {
        ...
        emailRequiredDialogTitle: 'Dodaj swój adres e-mail',
        emailRequiredDialogDescription: 'Konta administratora wymagają teraz zarejestrowanego adresu e-mail do odzyskiwania hasła i nazwy użytkownika. Dodaj swój, aby kontynuować.',
        emailRequiredSavedToast: 'Adres e-mail zapisany.',
      ...
      bookInfo: {
        openBtnTitle: 'Wyszukiwanie książek',
        openBtnLabel: 'Wyszukiwanie książek',
        heading: 'Wyszukiwanie książek',
        isbnLabel: 'ISBN',
        isbnPlaceholder: 'ISBN lub kod kreskowy',
        titleLabel: 'Tytuł',
        titlePlaceholder: 'Tytuł książki',
        authorLabel: 'Autor',
        authorPlaceholder: 'Imię autora (opcjonalnie)',
        orDivider: '— lub —',
        searchBtn: 'Szukaj',
        backBtn: 'Wstecz',
        addToWheelBtn: 'Dodaj do koła',
        pickHint: 'Znaleziono kilka książek. Wybierz jedną, aby zobaczyć szczegóły.',
        linksHeading: 'Znajdź tę książkę w internecie',
        googleBooksLink: 'Google Books',
        openLibraryLink: 'Open Library',
        goodreadsLink: 'Goodreads',
        bnLink: 'Barnes & Noble',
        amazonLink: 'Amazon',
        needsInputError: 'Podaj ISBN lub tytuł do wyszukania.',
        noResultsError: 'Nie znaleziono wyników.',
        isbnPrefix: 'ISBN: '
      },
      stats: {
