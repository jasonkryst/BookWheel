...
- Local default: `1.2.1-local` (set in `BookWheel/BookWheel.csproj`)
...
```bash
dotnet build BookWheel.slnx /p:InformationalVersion=1.2.1
docker build --build-arg APP_VERSION=1.2.1 -t jasonkryst/bookwheel:1.2.1 .
```
