...
- Local default: `1.1.0-local` (set in `BookWheel/BookWheel.csproj`)
...
```bash
dotnet build BookWheel.slnx /p:InformationalVersion=1.1.0
docker build --build-arg APP_VERSION=1.1.0 -t jasonkryst/bookwheel:1.1.0 .
```
