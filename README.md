...
- Local default: `1.0.8-local` (set in `BookWheel/BookWheel.csproj`)
...
```bash
dotnet build BookWheel.slnx /p:InformationalVersion=1.0.8
docker build --build-arg APP_VERSION=1.0.8 -t jasonkryst/bookwheel:1.0.8 .
```
